        ...
        <nav>
          <ul>
            ...
            <li>
              <Link
                to="/theatre"
                onClick={() => handleCategoryClick("/discover/movie?primary_release_date.gte=2014-09-15&primary_release_date.lte=2014-10-22")}
              >
                Theatre
              </Link>
            </li>
            <li>
              <Link
                to="/kids"
                onClick={() => handleCategoryClick("/discover/movie?certification_country=US&certification.lte=G&sort_by=popularity.desc")}
              >
                Kids
              </Link>
            </li>
            ...
            <li>
              <Link
                to="/comedy"
                onClick={() => handleCategoryClick("/discover/movie?with_genres=35&with_cast=23659&sort_by=revenue.desc")}
              >
                Comedy
              </Link>
            </li>
